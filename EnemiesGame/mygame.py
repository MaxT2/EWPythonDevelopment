...
import pygame
from os import path
from EnemiesGame.enemy import Enemy
from EnemiesGame.player import Player
from EnemiesGame.enemy2 import Enemy2
from EnemiesGame.enemy_barricade import EnemyBarricade
...
# keep track of 2nd type of EnemiesGame
...
# create first wave of EnemiesGame
for x in range(spawn_number):
    #create an enemy
    # EnemiesGame are added to the all_sprites and all_enemies groups
...
while running == True:
    ...
    # check players and EnemiesGame for collisions
