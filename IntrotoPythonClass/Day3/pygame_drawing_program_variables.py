...
# size variable for size of drawing tool
brush_size = 25
...
while running == True:
    ...
    if pygame.mouse.get_pressed() == (1, 0, 0):
        ...
        circle(game_surface, colors[color_position], (mouse_x, mouse_y), brush_size)
        print(brush_size)

    # check if right mouse button is pressed
    if pygame.mouse.get_pressed() == (0, 0, 1):
        # draw a white circle where the mouse is
        pygame.draw.circle(game_surface, WHITE, [mouse_x, mouse_y], brush_size)
